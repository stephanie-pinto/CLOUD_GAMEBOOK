...
public class EndpointsAsyncTaskGameDelete extends AsyncTask<Object, Object, List<Game>> {
private static GameApi gameApi = null;
private static final String TAG = EndpointsAsyncTaskCustomer.class.getName();
private Game game;

    EndpointsAsyncTaskGameDelete(){}

    EndpointsAsyncTaskGameDelete(Game game){
        this.game = game;
        }
...
public void initialize(AbstractGoogleClientRequest<?> abstractGoogleClientRequest) throws IOException {
        ...
        // For instance insert
        if(game != null){
            gameApi.remove(game.getId()).execute();
        Log.i(TAG, "delete driver");
        }
