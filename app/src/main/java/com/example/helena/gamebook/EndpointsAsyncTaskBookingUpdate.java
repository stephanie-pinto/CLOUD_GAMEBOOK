...
class EndpointsAsyncTaskBookingUpdate extends AsyncTask<Object, Object, List<Booking>> {
    private static BookingApi bookingApi = null;
    private static final String TAG = EndpointsAsyncTaskBookingUpdate.class.getName();
    private Booking booking;

    EndpointsAsyncTaskBookingUpdate(){}

    EndpointsAsyncTaskBookingUpdate(Booking booking){
    ...
    protected List<Booking> doInBackground(Object... params) {
        ...
        try{
            ...
            // For instance insert
            if(booking != null){
                bookingApi.update(booking.getId() ,booking).execute();
